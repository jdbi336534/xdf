        ...
        <Form layout="inline" className={styles.searchform}>
            <Row >
                ...
                <Col  span={5} >
                    ...
                    <Select size="small" placeholder="请选择学科组" style={{ width: 147,textAlign:'left' }} >
                ...
                <Col  span={6} >
                    ...
                    <Select size="small" placeholder="请选择预排速度" style={{ width: 147,textAlign:'left' }} >
                ...
                <Col  span={6} >
                    ...
                    <Select size="small" placeholder="请选择结转速度" style={{ width: 147,textAlign:'left' }} >
                    <Option value="fast">较快</Option>
                    <Option value="normal">正常</Option>
                    <Option value="slow">较慢</Option>
                    </Select>
