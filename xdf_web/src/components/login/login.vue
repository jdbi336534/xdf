    ...
    <Row type="flex" justify="center" align="middle">
      ...
      <Form ref="formInline" :model="formInline" :rules="ruleInline" class="login-form">
        <Form-item prop="username">
          <div class="logo"> <img alt="logo" src="../../assets/img/icon1.svg"> <span>数据统计平台</span> </div>
        ...
        <Form-item>
          <Button type="primary" :loading="loading" @click="handleSubmit('formInline')">登录</Button> </Form-item>
      </Form>
      </Col>
    </Row>
  </div>
