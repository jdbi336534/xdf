    ...
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="120" class="form">
      <Row>
        ...
        <Form-item label="本月预排完成率" prop="prescheduling">
          ...
          <label>
            <Input style="width:120px" v-model="formValidate.prescheduling"></Input> %</label>
        </Form-item>
        </Col>
        <Col span="12">
        <Form-item label="本月结转完成率" prop="carryover">
          <label>
            <Input style="width:120px" v-model="formValidate.carryover"></Input> %</label>
        </Form-item>
        </Col>
      </Row>
      <Row>
        ...
        <Form-item label="Q1预排完成率" prop="Q1prescheduling">
          <label>
            <Input style="width:120px" v-model="formValidate.Q1prescheduling"></Input> %</label>
        </Form-item>
        </Col>
        <Col span="12">
        <Form-item label="Q1结转完成率" prop="Q1carryover">
          <label>
            <Input style="width:120px" v-model="formValidate.Q1carryover"></Input> %</label>
        </Form-item>
        </Col>
      </Row>
      ...
      <div class="operation" v-show="show">
        ...
        <div class="upload">
          <Upload type="drag" action="/node/api/researchfile" :on-success="onfilesuccess" :before-upload="fileBeforeUpload" :on-remove="fileRemove">
...
export default {
  ...
  methods: {
    ...
    handleSuccess(res, file) {
      try {
        if (res.code === 200) {
          this.formValidate.imgpath.push(res.filepath);
        }
      } catch (err) {
        this.$Message.error(err.message);
      }
